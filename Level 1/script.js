...
function keyCheck(event)
{
    if(event.which== 13)
    {
        ...
        createBlockWorkId= setInterval(createBlock,90);
        moveBlockWorkerId= setInterval(moveBlock,90);
    ...
    if(event.which==32)
    {
        if(jumpWorkId==0)
        {
            ...
            jumpWorkId=setInterval(jump,90);
            jumpSound.play();
...
function moveBlock()
{
    for(var i=1;i<=blockId;i++)
    {
       ...
       //alert(newBlock)
       //119-(-91)
       if(newBlock< 119 & newBlock> -91)
       {

       // alert(dinoMarginTop);
       //300
       if(dinoMarginTop>300)
       {
...
function dead()
{
  ...
  if(deadImageNumber==9)
  {
    ...
    document.getElementById("neon").innerHTML.visibility= "visible";
  }
